...
func TestInsert_Should_Split_Root_When_It_Has_M_Keys(t *testing.T) {
	...
	res, stack := tree.GetRoot().findAndGetStack(MyInt(5), stack)

	assert.Len(t, stack, 2)
	assert.Equal(t, "5", res)
	assert.Equal(t, MyInt(3), tree.GetRoot().GetKeyAt(0))
}
...
func TestInsert_Internals(t *testing.T) {
	...
	val, stack := tree.GetRoot().findAndGetStack(MyInt(1), stack)
	...
	stack = make([]NodeIndexPair, 0)
	val, stack = tree.GetRoot().findAndGetStack(MyInt(2), stack)
	...
	tree.Insert(MyInt(3), "3")
	stack = make([]NodeIndexPair, 0)
	val, stack = tree.GetRoot().findAndGetStack(MyInt(3), stack)
	...
	stack = make([]NodeIndexPair, 0)
	val, stack = tree.GetRoot().findAndGetStack(MyInt(4), stack)
	...
	tree.Insert(MyInt(5), "5")
	stack = make([]NodeIndexPair, 0)
	val, stack = tree.GetRoot().findAndGetStack(MyInt(5), stack)
	...
	stack = make([]NodeIndexPair, 0)
	val, stack = tree.GetRoot().findAndGetStack(MyInt(6), stack)
	...
	stack = make([]NodeIndexPair, 0)
	val, stack = tree.GetRoot().findAndGetStack(MyInt(7), stack)
	...
	stack = make([]NodeIndexPair, 0)
	val, stack = tree.GetRoot().findAndGetStack(MyInt(8), stack)
	...
	stack = make([]NodeIndexPair, 0)
	val, stack = tree.GetRoot().findAndGetStack(MyInt(9), stack)
	...
	stack = make([]NodeIndexPair, 0)
	val, stack = tree.GetRoot().findAndGetStack(MyInt(10), stack)
